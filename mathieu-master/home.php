...
<body>
  ...
  <div class="main">
    ...
    <div id="slide">
          <img class="mySlides" src="PUBLIC/assets/images/images.jpg"
          style="width:63%">
          <img class="mySlides" src="PUBLIC/assets/images/images1.jpg"
          style="width:63%">
          <img class="mySlides" src="PUBLIC/assets/images/image3.jpg"
          style="width:63%">
        </div>
